...
const About = () => {
  return (
    ...
    <div className='flex flex-col text-[18px] justify-center items-center w-[58vw]'>
      ...
      <div className='flex gap-4 justify-center m-8 flex-wrap w-[58vw]'>
      <img className='w-[200px] h-[200px]' src={img2} alt="" />
        ...
        <img  className='w-[200px] h-[200px]'src={gal1} alt="" />
        <img  className='w-[200px] h-[200px]'src={gal2} alt="" />
        <img  className='w-[200px] h-[200px]'src={gal3} alt="" />
        <img  className='w-[200px] h-[200px]'src={gal4} alt="" />
        <img  className='w-[200px] h-[200px]'src={gal5} alt="" />
        <img  className='w-[200px] h-[200px]'src={gal6} alt="" />
      </div>
